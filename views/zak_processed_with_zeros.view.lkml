# The name of this view in Looker is "Zak Processed with Zeros"
view: zak_processed_with_zeros {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `test_dataset.zak_processed_with_zeros` ;;
  ...
  dimension: __of_stores_sold {
    type: number
    sql: ${TABLE}.__of_Stores_Sold ;;
  }
  ...
  measure: total___of_stores_sold {
    type: sum
    sql: ${__of_stores_sold} ;;  }
  measure: average___of_stores_sold {
    type: average
    sql: ${__of_stores_sold} ;;  }
